    ...
    public partial class ArticleSelector : ModuleBase
    {
        ...
        private void FillArticlesDropDown()
        {
            if (CategoryId.HasValue)
            {
                ...
                ArticlesDropDownList.DataSource = Item.GetAllChildren(ItemType.Article.GetId(), CategoryId.Value, Util.RelationshipType.ItemToParentCategory.GetId(), Util.RelationshipType.ItemToRelatedCategory.GetId(), PortalId);
