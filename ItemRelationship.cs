...
namespace Engage.Dnn.Publish
{
	...
	public class ItemRelationship : TransportableElement
	{
        ...
        public static void DisplayCategoryHierarchy(ListControl lc, int categoryId, int portalId, bool includeParentCategory, int itemToExclude)
        {
            ...
            {
                dt = Item.GetAllChildren(ItemType.Category.GetId(), categoryId, Util.RelationshipType.ItemToParentCategory.GetId(), portalId).Tables[0];
...
//			return dt;
        ...
        public override void Import(int currentModuleId, int portalId)
        {
            ...
            try
            {
                Util.RelationshipType type = Util.RelationshipType.GetFromName(RelationshipTypeName, typeof(Util.RelationshipType));
