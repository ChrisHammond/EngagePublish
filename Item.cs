...
namespace Engage.Dnn.Publish
{
    ...
    public abstract class Item : TransportableElement
    {
        ...
        public void AddView(int userId, int tabId, string ipAddress)
        {
            if (ModuleBase.IsViewTrackingEnabledForPortal(PortalId))
            {
                DataProvider.Instance().AddItemView(_itemId, _itemVersionId, userId, tabId, ipAddress);
            }
        }
        ...
        {
            ArrayList al = ItemRelationship.GetItemRelationships(ItemId, ItemVersionId, Util.RelationshipType.ItemToRelatedArticle.GetId(), true, _portalId);
        ...
        {
            ArrayList al = ItemRelationship.GetItemRelationships(_itemId, _itemVersionId, Util.RelationshipType.ItemToArticleLinks.GetId(), true, _portalId);
